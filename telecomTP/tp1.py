...
# Title: telecom
# Author: yassine ibenbrahim, amine hajji,toumany doumbouya
...
class tp1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "telecom", catch_exceptions=True)
        ...
        self.LO = LO = 2400000000

        ##################################################
        # Blocks
        ##################################################

        self._LO_range = Range(2400000000, 2483500000, 10000, 2400000000, 200)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/gnuradio/telecomTP/audioSave.grc', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/gnuradio/telecomTP/audioSave.grc', False)
